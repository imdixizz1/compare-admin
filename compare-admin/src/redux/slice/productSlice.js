...
export const deleteProduct = createAsyncThunk(
  ...
  async (id) => {
    return apiInstance.delete(`admin/product/deleteProduct?productId=${id}`);
  }
);
...
export const productDeleteImage = createAsyncThunk(
  ...
  async ({ productId, position }) => {
    const response = await apiInstance.delete(
      `admin/product/deleteImageOfProduct?productId=${productId}&position=${position}`
    );
