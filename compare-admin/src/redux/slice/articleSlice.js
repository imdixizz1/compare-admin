...
// redux/slice/articleSlice.js

export const articleDeleteImage = createAsyncThunk(
  'admin/article/deleteImage',
  async ({ articleId, position }) => {
    const response = await apiInstance.delete(
      `admin/article/deleteImageOfArticle?articleId=${articleId}&position=${position}`
    );
