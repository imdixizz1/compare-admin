  ...
  const handleSubmit = () => {
...

    {
      ...
      if (dialogueData) {
        ...
        dispatch(featureUpdate(payload)).unwrap();
      } else {
        let data = { formData, id: subcategoryId };
              ...
              <div className="row align-items-start formBody">
                <div className="col-12 col-md-6">
                  ...
                  <ExInput
                    ...
                    label={`Unit`}
                    placeholder={`Unit`}
                    errorMessage={error.unit && error.unit}
                    onChange={(e) => {
